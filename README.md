...
- Страница «Платежи Platega» в админке: список, поиск и ручная обработка пропущенных уведомлений.
...
1. Скачайте `Evrik-Platega-1000032.zip` из релиза. Архивы GitHub **Source code** не предназначены для установки через панель.
